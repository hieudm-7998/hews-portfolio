    ...
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 264 264">
        <g clipPath="url(#logoClip0)">
          <path
            className="text-themeOnPrimary"
            fill="currentColor"
            d="M128 256c56.089 0 87.269 0 107.635-20.365C256 215.269 256 184.089 256 128c0-56.089 0-87.27-20.365-107.635C215.269 0 184.089 0 128 0 71.911 0 40.73 0 20.365 20.365 0 40.731 0 71.911 0 128c0 56.089 0 87.269 20.365 107.635C40.731 256 71.911 256 128 256z"
          />
          <path
          ...
          />
          <path
            className="text-themeBackground"
            fill="currentColor"
            d="M156.764 57.347c1.714-6.396-6.277-10.82-10.788-5.973L82.412 119.67c-3.263 3.506-1.62 9.226 3.007 10.466l23.883 6.399a6.354 6.354 0 014.493 7.782l-14.559 54.336c-1.714 6.396 6.277 10.821 10.789 5.973l63.563-68.295c3.264-3.507 1.62-9.227-3.007-10.467l-23.883-6.399a6.354 6.354 0 01-4.493-7.782l14.559-54.336z"
          />
        </g>
